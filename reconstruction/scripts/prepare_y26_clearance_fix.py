...
mouth=Polygon([xy(-.2,-2.65),xy(8.75,-2.65),xy(8.75,2.65),xy(-.2,2.65)]);walls=set_precision(full.difference(full.buffer(-.2)).difference(mouth),.0001);mesh=runpy.run_path('/tmp/civic-stage00/reconstruction/scripts/prepare_mall_shells.py')['mesh'];parts=[{'name':'Y26_B_INTEGRATED_FLOOR','mesh':mesh(full,-3.9,-3.6)}]
