...
for key,p in paths.items():
 ...
 start=end-n*(pa['halfwidth']+.07)+Vector((0,0,.9));finish=Vector(pb['a'])+n*(pb['halfwidth']+.07)+Vector((0,0,.9));c=start+h*.99;c.z=z+.9;d=finish+h*.99;d.z=z+.9;vs=[];fs=[]
 def tube(a,b,r):
