...
s=bpy.data.scenes.new('UB_GUANGFU_SERVICE_REVIEW')
s.collection.children.link(bpy.data.collections['UB_GUANGFU_SERVICE_HOUSE_EST'])
for o in bpy.data.scenes['CIVIC_UNDERBRIDGE_MASSING_20260916'].objects:
 ...
 if 4650<x<4800 and any(k in o.name for k in ['MEDIAN_WORKING','COMP_ACCESS','VENT_DETAIL','COMP_MEDIAN','UB_LINSEN','Pier_']):s.collection.objects.link(o)
...
for tag,x,y in [('GUANGFU_SERVICE',4713,410)]:
