...
s=bpy.data.scenes.new('UB_DUNYAN_WEST_REVIEW')
s.collection.children.link(bpy.data.collections['UB_DUNYAN_WEST_OBSERVED_EST'])
for o in bpy.data.scenes['CIVIC_UNDERBRIDGE_MASSING_20260916'].objects:
 ...
 if 3900<x<4090 and any(k in o.name for k in ['MEDIAN_WORKING','COMP_ACCESS','VENT_DETAIL','COMP_MEDIAN','UB_LINSEN','Pier_']):s.collection.objects.link(o)
...
for tag,x,y in [('DUNYAN_CANOPY',4010,387),('DUNYAN_EQUIPMENT',3943,390)]:
