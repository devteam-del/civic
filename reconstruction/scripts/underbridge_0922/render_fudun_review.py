...
s=bpy.data.scenes.new('UB_FUDUN_FINAL_REVIEW')
s.collection.children.link(bpy.data.collections['UB_FUDUN_CANOPY_LANDSCAPE_EST'])
for o in bpy.data.scenes['CIVIC_UNDERBRIDGE_MASSING_20260916'].objects:
 ...
 if 3450<x<3720 and any(k in o.name for k in ['MEDIAN_WORKING','COMP_ACCESS','VENT_DETAIL','COMP_MEDIAN','UB_LINSEN','Pier_']):s.collection.objects.link(o)
...
for tag,x,y in [('FUDUN_CANOPY',3556,416),('FUDUN_LANDSCAPE',3670,420)]:
