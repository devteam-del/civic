...
s=bpy.context.scene;c=bpy.data.collections['UB_JIANFU_WALL_FENCE_EST']
hedges=[o for o in c.objects if 'DARK_FENCE' in o.name]
...
json.dump(report,open(os.path.join(root,'jianfu_fence_clearance_report.json'),'w'),indent=2)
