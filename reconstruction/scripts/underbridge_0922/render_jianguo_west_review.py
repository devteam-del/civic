...
s=bpy.data.scenes.new('UB_JIANGUO_WEST_REVIEW')
s.collection.children.link(bpy.data.collections['UB_JIANGUO_WEST_023_025_EST'])
for o in bpy.data.scenes['CIVIC_UNDERBRIDGE_MASSING_20260916'].objects:
 ...
 if 2280<x<2640 and any(k in o.name for k in ['MEDIAN_WORKING','COMP_ACCESS','VENT_DETAIL','COMP_MEDIAN','UB_LINSEN','Pier_']):s.collection.objects.link(o)
...
for tag,x,y in [('JIANGUO_WEST',2352,436),('JIANGUO_EAST',2527,401)]:
