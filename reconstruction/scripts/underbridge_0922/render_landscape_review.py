...
s=bpy.data.scenes.new('UB_LANDSCAPE_011_018_REVIEW')
s.collection.children.link(bpy.data.collections['UB_LANDSCAPE_011_018_EST'])
for o in bpy.data.scenes['CIVIC_UNDERBRIDGE_MASSING_20260916'].objects:
 ...
 if 1100<x<1950 and any(k in o.name for k in ['MEDIAN_WORKING','COMP_ACCESS','VENT_DETAIL','COMP_MEDIAN','UB_LINSEN','Pier_']):s.collection.objects.link(o)
...
for tag,x,y in [('ZHONGLIN',1298,724),('LINJIN',1655,650),('RAMP',1848,585)]:
