...
root=pathlib.Path('/Users/ktlu/Desktop/Civic_Rebuild_20260909_201934/Calibration');out=root/'camera_renders';out.mkdir(exist_ok=True);sc=bpy.data.scenes['CIVIC_COMPLETE_WORKING_ASSEMBLY'];cams=sorted([o for o in sc.objects if o.type=='CAMERA' and o.name!='FRONTAGE_HEIGHT_CAMERA'],key=lambda o:o.name);start=CAL_START;end=CAL_END
