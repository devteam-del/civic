...
scene=bpy.data.scenes.new('QA_FUXING_SERVICE_XY_EST')
...
for obj in bpy.context.scene.objects:
 ...
 take=obj.name in ['SV_FUXING_ROAD_EST','SV_FUXING_SERVICE_MEDIAN_EST']
...
camera.location=(3328,389,120);camera.rotation_euler=(0,0,0)
...
scene.render.filepath=str(root/'fuxing_service_xy_est_plan.png')
