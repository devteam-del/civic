...
profile=Polygon([(4457,ws)]+[(x,y-2) for x,y in south]+[(4768,es),(4768,en)]+[(x,y+2) for x,y in reversed(north)]+[(4457,wn)])
new=unary_union([old.difference(box(4457,300,4768,450)),profile]).difference(unary_union(holes))
...
patches.append(dict(source_object='SV_RAMP_EAST_MEDIAN_EST_V2',new_name='SV_GUANGFU_WEST_MEDIAN_EST',footprint=mapping(new),vertices=v,faces=f))
checks=[]
