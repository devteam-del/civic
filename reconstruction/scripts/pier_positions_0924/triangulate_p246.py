...
views=[{'pano':'akMOb0qFNqnQ6f7z51SldA','lat':25.044956,'lon':121.5469716,'heading':298,'date':'2024-12'}, {'pano':'aBo2wQlsJzMEiNZ9NQDZew','lat':25.0449653,'lon':121.5468703,'heading':330,'date':'2024-12'}, {'pano':'uKMagVCBFOMP5Zreqyt1Gg','lat':25.0449469,'lon':121.5470737,'heading':289.2,'date':'2024-12','role':'third_view_crosscheck'}]
...
out={'target':'Visible P246, roadside shaft west of U-turn opening; downpipe and planted island','candidate_model_xy':p,'views':views,'method':'Intersection of two visually centered December 2024 Street View bearings; geodesic heading projected to EPSG3826 then established model transform. Primary views separated by 32 degrees; third view is a ray crosscheck, not survey validation.','uncertainty':'Not surveyed. Camera geolocation, panorama heading, target matching and visual centering errors remain unquantified. A 3m display ring is a review guide, not a statistical confidence interval.','real_world_verified':False,'height_changed':False}
