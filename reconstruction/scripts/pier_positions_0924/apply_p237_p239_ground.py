...
d=json.loads((root/'p237_p239_ground_comparison.json').read_text())
replacements={};checks=[]
for patch in d['patches']:
 ...
 ob['source_object']=old.name;ob['source_record']='p237_p239_ground_comparison.json'
...
(root/'p237_p239_ground_application.json').write_text(json.dumps(report,indent=2))
result=report
