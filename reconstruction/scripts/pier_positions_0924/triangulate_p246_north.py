...
views=[{'pano':'akMOb0qFNqnQ6f7z51SldA','lat':25.044956,'lon':121.5469716,'heading':326,'date':'2024-12'}, {'pano':'aBo2wQlsJzMEiNZ9NQDZew','lat':25.0449653,'lon':121.5468703,'heading':351,'date':'2024-12'}, {'pano':'uKMagVCBFOMP5Zreqyt1Gg','lat':25.0449469,'lon':121.5470737,'heading':311,'date':'2024-12','role':'third_view_crosscheck'}]
...
out={'target':'North-side shaft opposite visible P246 at west end of U-turn opening; own label unread','candidate_model_xy':p,'views':views,'method':'Intersection of two visually centered December 2024 Street View bearings; geodesic heading projected to EPSG3826 then established model transform. Two primary bearings plus a third-view ray crosscheck, not survey validation.','uncertainty':'Not surveyed. Camera geolocation, panorama heading, target matching and visual centering errors remain unquantified. A 3m display ring is a review guide, not a statistical confidence interval.','real_world_verified':False,'height_changed':False}
