...
scene=bpy.data.scenes.new('QA_RAMP_EAST_XY_EST')
...
for obj in bpy.context.scene.objects:
 ...
 take=obj.name in ['SV_YANJI_ROAD_OPENINGS_EST','SV_RAMP_EAST_MEDIAN_EST']
...
camera.location=(4505,375,120);camera.rotation_euler=(0,0,0)
data.type='ORTHO';data.ortho_scale=120;scene.camera=camera
scene.render.resolution_x=1800;scene.render.resolution_y=750;scene.render.resolution_percentage=100
scene.render.image_settings.file_format='PNG'
scene.render.filepath=str(root/'ramp_east_xy_est_plan.png')
