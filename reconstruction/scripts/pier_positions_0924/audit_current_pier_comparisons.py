...
junction=json.loads((r24/'p237_p239_ground_comparison.json').read_text())
...
road=unary_union([geo(o) for o in source['roads'] if o['name']!=entry['source_road']]+[shape(p['footprint']) for p in junction['patches'] if p['new_name']=='SV_P237_P239_ROAD_EST'])
