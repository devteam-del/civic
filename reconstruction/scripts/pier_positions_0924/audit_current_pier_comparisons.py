...
junction=json.loads((r24/'dunhua_median_comparison.json').read_text())
...
for filename in ['p248_position_review.json','east248_position_review.json','p250_position_review.json','dunhua_junction_position_review.json']:
