...
def section(g,x):
 ...
 return b[1],b[3]
ws,wn=section(west,3810);es,en=section(east,4005)
wp=Polygon([(3810,ws),(3848,395.7),(3851.8,396),(3854.7,398),(3855.2,400),(3855.2,408.6),(3854.5,410.6),(3852.2,411.1),(3849.8,411),(3810,wn)])
ep=Polygon([(3926.6,387.8),(3927.5,386.2),(3929.5,385.8),(3932.2,386),(3979.9,380.1),(4005,es),(4005,en),(3981.6,395.9),(3933,401.4),(3930.2,401.1),(3927.3,399.3),(3926.6,397.6)])
wg=unary_union([west.difference(box(3810,300,3860,480)),wp]);eg=unary_union([east.difference(box(3920,300,4005,480)),ep])
def mesh(g,z0=0,z1=.18):
 ...
 return verts,faces
patches=[]
for old,new,g in [('SV_FUDUN_ENTRY_MEDIAN_EST','SV_DUNHUA_WEST_MEDIAN_EST',wg),('SV_DUNHUA_EAST_MEDIAN_EST','SV_DUNHUA_EAST_MEDIAN_RAMP_EST',eg)]:
 assert g.is_valid
