...
d=json.loads((root/'fuxing_service_ground_comparison.json').read_text())
replacements={};checks=[]
for patch in d['patches']:
 ...
 ob['source_object']=old.name;ob['source_record']='fuxing_service_ground_comparison.json'
...
(root/'fuxing_service_ground_application.json').write_text(json.dumps(report,indent=2))
result=report
