...
scene=bpy.data.scenes.new('QA_FUXING_JUNCTION_XY_EST')
...
for obj in bpy.context.scene.objects:
 ...
 take=obj.name in ['SV_FUXING_ROAD_EST','SV_FUXING_WEST_MEDIAN_V2_EST','SV_P237_P239_MEDIAN_EST']
...
camera.location=(3382,397,120);camera.rotation_euler=(0,0,0)
data.type='ORTHO';data.ortho_scale=90;scene.camera=camera
scene.render.resolution_x=1800;scene.render.resolution_y=750;scene.render.resolution_percentage=100
scene.render.image_settings.file_format='PNG'
scene.render.filepath=str(root/'fuxing_junction_xy_est_plan.png')
