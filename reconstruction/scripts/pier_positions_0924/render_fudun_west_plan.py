...
scene=bpy.data.scenes.new('QA_FUDUN_WEST_XY_EST')
...
for obj in bpy.context.scene.objects:
 ...
 take=obj.name in ['SV_FUDUN_WEST_ROAD_EST','SV_FUDUN_WEST_MEDIAN_EST']
...
camera.location=(3610,425,120);camera.rotation_euler=(0,0,0)
...
scene.render.filepath=str(root/'fudun_west_xy_est_plan.png')
