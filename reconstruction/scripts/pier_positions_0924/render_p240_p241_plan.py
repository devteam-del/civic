...
scene=bpy.data.scenes.new('QA_P240_P241_XY_EST')
...
for obj in bpy.context.scene.objects:
 ...
 take=obj.name in ['SV_P240_P241_ROAD_EST','SV_P240_P241_MEDIAN_EST']
...
camera.location=(3520,413,120);camera.rotation_euler=(0,0,0)
data.type='ORTHO';data.ortho_scale=65;scene.camera=camera
scene.render.resolution_x=1800;scene.render.resolution_y=750;scene.render.resolution_percentage=100
scene.render.image_settings.file_format='PNG'
scene.render.filepath=str(root/'p240_p241_xy_est_plan.png')
