...
scene=bpy.data.scenes.new('QA_P237_P239_XY_EST')
...
for obj in bpy.context.scene.objects:
 ...
 take=obj.name in ['SV_P237_P239_ROAD_EST','SV_P237_P239_MEDIAN_EST']
...
camera.location=(3446,406,120);camera.rotation_euler=(0,0,0)
data.type='ORTHO';data.ortho_scale=95;scene.camera=camera
scene.render.resolution_x=1800;scene.render.resolution_y=750;scene.render.resolution_percentage=100
scene.render.image_settings.file_format='PNG'
scene.render.filepath=str(root/'p237_p239_xy_est_plan.png')
